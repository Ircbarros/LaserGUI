...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Terminal = QtWidgets.QWidget(self.Base)
        self.Terminal.setGeometry(QtCore.QRect(121, 470, 1160, 131))
        ...
        self.VelocityLabel.setGeometry(QtCore.QRect(80, 9, 61, 16))
        ...
        self.Battery.setGeometry(QtCore.QRect(1110, 170, 40, 40))
        ...
        self.BatteryValue.setGeometry(QtCore.QRect(1110, 210, 41, 23))
        self.BatteryValue.setObjectName("BatteryValue")
        self.Wifi = QtWidgets.QFrame(self.Base)
        self.Wifi.setGeometry(QtCore.QRect(1200, 170, 40, 40))
        ...
        self.WifiValue.setGeometry(QtCore.QRect(1200, 210, 41, 23))
        ...
        self.PlayButton.setGeometry(QtCore.QRect(20, 35, 71, 21))
        ...
        self.JoystickButton.setGeometry(QtCore.QRect(120, 35, 71, 21))
        ...
        self.PauseButton.setGeometry(QtCore.QRect(20, 65, 71, 21))
        ...
        self.StopButton.setGeometry(QtCore.QRect(118, 65, 71, 21))
        ...
        self.RobotSelection.setGeometry(QtCore.QRect(730, 10, 218, 91))
        ...
        self.RobotSelectionLabel.setGeometry(QtCore.QRect(49, 5, 121, 16))
        ...
        self.TeamOneButton = QtWidgets.QRadioButton(self.RobotSelection)
        self.TeamOneButton.setGeometry(QtCore.QRect(10, 40, 81, 21))
        self.TeamOneButton.setStyleSheet("background: transparent;\n"
                                         "color: rgb(206, 255, 188);")
        self.TeamOneButton.setObjectName("TeamOneButton")
        self.TeamTwoButton = QtWidgets.QRadioButton(self.RobotSelection)
        self.TeamTwoButton.setGeometry(QtCore.QRect(120, 40, 81, 21))
        self.TeamTwoButton.setStyleSheet("background: transparent;\n"
                                         "color: rgb(206, 255, 188);")
        self.TeamTwoButton.setObjectName("TeamTwoButton")
        self.XNumber = QtWidgets.QLCDNumber(self.Base)
        self.XNumber.setGeometry(QtCore.QRect(1090, 400, 31, 23))
        ...
        self.YNumber = QtWidgets.QLCDNumber(self.Base)
        self.YNumber.setGeometry(QtCore.QRect(1170, 400, 31, 23))
        ...
        self.ZNumber = QtWidgets.QLCDNumber(self.Base)
        self.ZNumber.setGeometry(QtCore.QRect(1240, 400, 31, 23))
        self.ZNumber.setObjectName("ZNumber")
        ...
        self.PitchNumber = QtWidgets.QLCDNumber(self.Base)
        self.PitchNumber.setGeometry(QtCore.QRect(1125, 430, 31, 23))
        self.PitchNumber.setObjectName("PitchNumber")
        ...
        self.YallLabel = QtWidgets.QLabel(self.Base)
        self.YallLabel.setGeometry(QtCore.QRect(1185, 435, 41, 16))
        self.YallLabel.setStyleSheet("background: transparent;\n"
                                     "font: 11pt \"Sans Serif\";\n"
                                     "color: rgb(206, 255, 188);")
        self.YallLabel.setObjectName("YallLabel")
        ...
        self.ZNumber.raise_()
        self.ZLabel.raise_()
        self.PitchNumber.raise_()
        self.PitchLabel.raise_()
        self.YallLabel.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.FelipeButton.setText(_translate("MainWindow", "Felipe"))
        ...
        self.TeamOneButton.setText(_translate("MainWindow", "TEAM 1"))
        self.TeamTwoButton.setText(_translate("MainWindow", "TEAM 2"))
        ...
        self.YallLabel.setText(_translate("MainWindow", "Yall:"))
